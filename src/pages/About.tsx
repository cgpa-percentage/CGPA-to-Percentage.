  ...
  <Layout>
    ...
    <article className="max-w-3xl mx-auto">
      ...
      <div className="glass-panel p-8 md:p-12 space-y-6 text-muted-foreground leading-relaxed">
        <p><strong className="text-foreground">CGPA Calculator</strong> is a free online platform designed to help students worldwide with academic performance calculations. We simplify navigating different grading systems.</p>
