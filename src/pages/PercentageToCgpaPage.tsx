  ...
  <Layout>
    <SEOHead
      ...
      jsonLd={{
        ...
        "aggregateRating": { "@type": "AggregateRating", "ratingValue": "4.7", "ratingCount": "38", "bestRating": "5", "worstRating": "1" }
      }}
    />
    ...
    <article className="glass-panel p-8 md:p-12 mt-12">
      ...
      <div className="space-y-4 text-muted-foreground text-sm leading-relaxed">
        <p>Our <a href="https://cgpafullform.com/cgpa-calculator" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline"><strong>CGPA Calculator</strong></a> handles the reverse conversion — from percentage to CGPA — just as accurately. This is essential when transitioning between grading systems.</p>
